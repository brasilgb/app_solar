...
export default Yup.object().shape({
    ...
    cepCliente: Yup.string().min(9, 'CEP inválido').required("Por favor, informe o CEP"),
    ...
    nascimentoCliente: Yup.string().min(8, 'Data inválida').required("Por favor, informe sua data nascimento")
});