    ...
    return (
        ...
        >
            ...
            <View className="flex-col items-center justify-center px-12">
                <Text className="mt-10 font-Poppins_300Light text-[26px] text-center text-white">Seu cadastro foi concluido com sucesso, agora defina sua senha!</Text>
                ...
                >
                    <Text className="text-lg w-10/12 font-Poppins_500Medium text-solar-blue-dark">Criar uma senha</Text>
                </TouchableOpacity>
            </View>
        </AppLayout>
    )
